...
public class StewardsActionBean implements ActionBean {
    ...
    public Resolution ajaxDelete(){
        ...
        try{
            ...
            return new StreamingResolution("text/html","<h4>Warning!</h4>Delete of steward with ID "+steward.getId()+" was not successfull.<strong> There might be flight using this steward.</strong>");
        }
