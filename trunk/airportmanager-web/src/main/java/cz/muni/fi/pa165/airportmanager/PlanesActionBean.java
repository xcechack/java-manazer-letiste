...
public class PlanesActionBean implements ActionBean {
    ...
    public Resolution ajaxDelete(){
        ...
        try{
            ...
            return new StreamingResolution("text/html","<h4>Warning!</h4>Delete of plane with ID "+plane.getId()+" was not successfull.<strong> There might be flight using this destination.</strong>");
        }
